function [rob_mean,Bg,cg,info]=rob_bc_nw(Data,components,max_iter,display,Sigma_end,Sigma_start,iter_grad,Bg,cg,rob_mean)
...
info(iter,:)=[errsvd angular_error time];
